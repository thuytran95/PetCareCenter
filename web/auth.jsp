<%-- Document : auth Created on : Sep 14, 2025, 5:10:56 PM Author : Admin --%>
          ...
          <div class="row">
            <div class="col-6">
              <div class="auth-content">
                ...
                <p>
                  Trở thành thành viên của hội yêu thú cưng tại trung tâm, bạn
                  sẽ có thể nhận được thông báo các chương tình ưu đã mới sớm
                  nhất, theo dõi chi tiết sổ sức khỏe của thú cưng và vô vàn
                  tiện ích khác.
                </p>
                <p>Hãy tham gia ngay thôi!</p>
                <div class="d-flex gap-2">
                  <a
                    class="btn btn-outline-blue px-5"
                    href="<%=request.getContextPath()%>/login"
                    >Đăng nhập</a
                  >
                  <a
                    class="btn btn-primary-blue px-5"
