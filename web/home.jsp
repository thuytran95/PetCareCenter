<%-- 
    Document   : home
    Created on : Sep 6, 2025, 10:03:17 AM
    Author     : Admin
--%>
                        ...
                        <div class="d-flex flex-lg-row flex-column">
                            <div class="w-20">
                                ...
                                <div class="banner-content text-justify">
                                    <p>Trung tâm Chăm sóc thú cưng là nơi gửi gắm yêu thương để thú cưng luôn khỏe mạnh, hạnh phúc và được nâng niu.</p>
                                    <p>Chúng tôi chăm sóc thú cưng của bạn bằng tình yêu và sự tận tâm, luôn coi các bé như những người bạn nhỏ thân yêu trong gia đình.</p>
                                </div>
                    ...
                    <div class="row">
                        <div class="col-12 col-lg-6">
                            <div class="d-flex flex-column  ">
                                ...
                                <p>Chúng tôi cung cấp các dịch vụ chăm sóc thú cưng toàn diện – từ sức khỏe đến nghỉ dưỡng</p>
                                ...
                                <div class="row">
                                    <div class="col-12 col-sm-6">
                                        <div class="service-item">
                                            ...
                                            <p class="text-justify">Thư giãn, nâng niu từng phút giây cho các bé thú cưng</p>
                                    ...
                                    <div class="col-12 col-sm-6">
                                        <div class="service-item">
                                            ...
                                            <p class="text-justify">Ngôi nhà thứ hai ấm áp, an toàn và đầy yêu thương</p>
                                            <a class="service-item-link" href="#">Xem thêm</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-12 col-sm-6">
                                        <div class="service-item">
                                            ...
                                            <p class="text-justify">Bảo vệ thú cưng từ những phương pháp phòng chống bệnh tốt nhất</p>
                                            <a class="service-item-link" href="#">Xem thêm</a>
                                        </div>
                                    </div>
                                    <div class="col-12 col-sm-6">
