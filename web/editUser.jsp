            ...
            <form method="post" action="editUser" enctype="multipart/form-data">
                ...
                <div class="d-flex align-items-end gap-3 mb-5">
                    <div class="user-avatar">
                        <% if (user.getAvatar() != null) { %>
                            <img src="data:image/png;base64,<%= Base64.getEncoder().encodeToString(user.getAvatar()) %>" class="rounded-circle" width="100" height="100"/>
                        <% } else { %>
                ...
                <div class="form-container">
                    ...
                    <select class="form-select" name="gender">
                        <option value="F" <%= "F".equals(user.getGender()) ? "selected" : "" %>>Nữ</option>
                        <option value="M" <%= "M".equals(user.getGender()) ? "selected" : "" %>>Nam</option>
                    </select>
                </div>
