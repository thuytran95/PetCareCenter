 ...
 * @author Duyet
 */
@WebServlet("/SpaBookingServletGuest")
public class SpaBookingServletGuest extends HttpServlet{
     @Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.getRequestDispatcher("bookSpaGuest.jsp").forward(request, response);
        } catch (Exception e) {
            e.printStackTrace();
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.getRequestDispatcher("bookSpaResultGuest.jsp").forward(request, response);
